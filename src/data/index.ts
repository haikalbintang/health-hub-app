...
import chef4 from "@/components/images/Pierre-Gagnaire.jpg";

import tools1 from "@/components/images/butcher.svg";
import tools2 from "@/components/images/grater.svg";
import tools3 from "@/components/images/pizza-knife.svg";
import tools4 from "@/components/images/spatula.svg";
...
export const recipeDetail = {
  ...
  instructions: [
    "Cook the Pasta Bring a large pot of salted water to a boil. Cook the pasta according to the package instructions until al dente. Drain and set aside, reserving about 1/2 cup of pasta water.",
    " Cut the tomatoes into small cubes and set aside. In a large skillet, heat the olive oil over medium heat. Add the garlic, and cook for 1 minute until fragrant.",
    " Add the tomato cubes, salt, pepper, and the pasta water. Mix well and cook for 5-7 minutes until the sauce has thickened.",
